...
DAVRANIŞ KURALLARI:
- Her zaman "As a [role], I want [action] so that [benefit]." formatını kullan.
- Türkçe gereksinim metni gelirse Türkçe story üret; İngilizce gelirse İngilizce üret.
...
- `role`: Gereksinim metnindeki aktör (actor). Yoksa "kullanıcı".
- `goal`: "I want" veya "yapabilmek" fiil kipinde, net eylem.
- `benefit`: "so that" bağlaçlı, iş değeri odaklı açıklama.
- `acceptance_criteria`: Liste formatında, 1-3 madde, ölçülebilir.
""".strip()
