...
GROUND_TRUTH = [
    ...
    ("Sistem, stokta olmayan ürünleri sepete eklenmesine izin vermemelidir.", {"sistem"}, "FUNCTIONAL", "e-ticaret"),
    ("Sistem, stokta olmayan ürünler sepete eklenebilmeli; ancak ödeme sırasında uyarı gösterilmelidir.", {"sistem"}, "FUNCTIONAL", "e-ticaret"),
    ...
    ("Sistem, sipariş tamamlandıktan sonra stok miktarını otomatik güncellenmelidir.", {"sistem"}, "FUNCTIONAL", "e-ticaret"),
    ...
    # ── 03 EĞİTİM / MUĞLAK (12) ──
    ("Sistem hızlı olmalıdır.", {"sistem"}, "NON_FUNCTIONAL", "eğitim"),
    ("Öğrenciler sistemi kolayca kullanabilmelidir.", {"öğrenci"}, "NON_FUNCTIONAL", "eğitim"),
    ("Platform güvenli olmalıdır.", {"platform"}, "NON_FUNCTIONAL", "eğitim"),
    ("İçerikler kaliteli sunulmalıdır.", set(), "NON_FUNCTIONAL", "eğitim"),
    ("Sistem her zaman erişilebilir olmalıdır.", {"sistem"}, "NON_FUNCTIONAL", "eğitim"),
    ...
    ("Sistem yüksek trafiği kaldırabilmelidir.", {"sistem"}, "NON_FUNCTIONAL", "eğitim"),
    ("Arayüz kullanıcı dostu tasarlanmalıdır.", set(), "NON_FUNCTIONAL", "eğitim"),
    ("Veri güvenli saklanmalıdır.", set(), "NON_FUNCTIONAL", "eğitim"),
    ("Sistem ölçeklenebilir olmalıdır.", {"sistem"}, "NON_FUNCTIONAL", "eğitim"),
    ("Uygulama farklı cihazlarda düzgün çalışmalıdır.", {"uygulama"}, "NON_FUNCTIONAL", "eğitim"),
    ...
    ("Uygulama, Android 10 ve üzeri ile iOS 15 ve üzeri sürümlerde çalışmalıdır.", {"uygulama"}, "NON_FUNCTIONAL", "mobil"),
    ("Uygulama açılış süresi soğuk başlatmada 3 saniyeyi geçmemelidir.", {"uygulama"}, "NON_FUNCTIONAL", "mobil"),
    ("Sayfa geçişleri 500 milisaniyenin altında tamamlanmalıdır.", set(), "NON_FUNCTIONAL", "mobil"),
    ("Uygulama, 10.000 eş zamanlı kullanıcıyı desteklemelidir.", {"uygulama"}, "NON_FUNCTIONAL", "mobil"),
    ("Çevrimdışı modda son 7 günlük veri önbellekten erişilebilir olmalıdır.", set(), "NON_FUNCTIONAL", "mobil"),
    ("Uygulama batarya tüketimi günde 2 saat aktif kullanımda %5'i geçmemelidir.", {"uygulama"}, "NON_FUNCTIONAL", "mobil"),
    ...
    ("Uygulama %99,9 SLA hedefini karşılamalıdır.", {"uygulama"}, "NON_FUNCTIONAL", "mobil"),
    ...
    ("Uygulama boyutu 50 MB'ı geçmemelidir.", {"uygulama"}, "NON_FUNCTIONAL", "mobil"),
